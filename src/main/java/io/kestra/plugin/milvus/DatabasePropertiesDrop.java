      ...
      @Example(
          ...
          code =
              """
                ...
                tasks:
                  - id: database_drop
                    type: io.kestra.plugin.milvus.DatabasePropertiesDrop
...
public class DatabasePropertiesDrop extends MilvusConnection
    implements RunnableTask<DatabasePropertiesDrop.Output> {
